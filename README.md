...
|-|-|-|-|
| Тихонова А.А | 253-332 | 09.03.02 | Автоматизированные системы обработки информации и управления |
| Горячев И.А | 253-332 | 09.03.02 | Автоматизированные системы обработки информации и управления |
...
Меньшикова Наталия Павловна, "Информатики и информационных технологий".

## Проектная деятельность

Проектная (учебная) практика проводилась в связке с выполнением проекта «Jerry-Spiced» по дисциплине «Проектная деятельность».

Суровец Владимир Александрович.

## Период проведения

С 03 Июня 2026 г. по 13 Июня 2026 г.
